...
import com.palagi.demo_park_api.jwt.JwtUserDetailsService;
import com.palagi.demo_park_api.web.dto.UsuarioLoginDto;
...
import com.palagi.demo_park_api.jwt.JwtToken;
...
public class AutenticacaoController {
    ...
    @Operation(summary = "Autenticar na API", description = "Recurso de autenticacao na API", responses = {
            @ApiResponse(responseCode = "200", description = "Auntenticacao realizada com sucesso e retorno de um bearer token",
            ...
            @ApiResponse(responseCode = "422", description = "Campo(s) invalidos(s)",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class)))
    })
    @PostMapping("/auth")
